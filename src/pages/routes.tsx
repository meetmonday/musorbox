...
app.get("/public/circles", (c) =>
  renderSectionPage(c, {
    ...
    children: sectionBody(
      "Колонки",
      [
        "Авторские колонки постоянных авторов Трешбокса.",
...
app.get("/public/trashcast", (c) =>
  renderSectionPage(c, {
    ...
    children: sectionBody(
      "Трешкаст",
      [
        "Аудио- и видеоподкасты редакции Трешбокса о новостях мобильного мира.",
        "Обсуждаем свежие анонсы, железа и софт, отвечаем на вопросы читателей.",
        "Раздел находится в разработке. Следите за обновлениями!",
      ],
    ),
  }),
...
app.get("/public/users", (c) =>
  renderSectionPage(c, {
    ...
    children: sectionBody(
      "Конкурсы",
      [
        "Конкурсы для читателей Трешбокса: призы, активности и рейтинги пользователей.",
...
app.get("/thanks", (c) =>
  renderPlainPage(c, {
    ...
    children: sectionBody(
      "Благодарности",
      [
        "Трешбокс не состоялся бы без наших читателей, авторов и модераторов.",
  ...
  renderPlainPage(c, {
    ...
    children: sectionBody(
      ...
      [
        ...
        "По вопросам рекламы и сотрудничества обращайтесь по адресу: advertise@trashbox.ru",
      ],
    ),
  }),
);
